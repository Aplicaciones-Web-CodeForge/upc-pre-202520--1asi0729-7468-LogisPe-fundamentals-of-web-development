...
Este curso de 1 hora introduce a estudiantes de secundaria a la creación de sitios web sencillos con HTML y CSS. **¡Norequiere descargas!** Solo abre tu navegador web.
...
- Escribir HTML básico y agregar elementos importantes
- Aplicar CSS para mejorar la apariencia
- Crear un mini proyecto web
- Usar herramientas online para programar
- Conocer buenas prácticas para seguir creciendo
...
- **Enlace**: [Ver la lección](https://youtu.be/i3d9EMlKQbI)
...
- **Código Fuente Completo**: [Repositorio de GitHub](https://github.com/Aplicaciones-Web-CodeForge/upc-pre-202520--1asi0729-7468-LogisPe-fundamentals-of-web-development)
...
**Nombre del equipo**: CodeForge

**Líder del equipo**: Mathias Javier Murillo

**Integrantes del equipo**:

- Aguilar Untiveros, Rodrigo Fabrizio
- Condori Lozano, Alessandro Ramiro
- Murillo, Mathias Javier
- Mejia Aliaga, Katherine Maryory
- Montes Maza, Augusto Sebastia

**Fecha de entrega**: 12-11-2025

---

**¡Gracias por completar el curso de Fundamentos del Desarrollo Web**
